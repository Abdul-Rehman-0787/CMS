...
public:
    ...
    void initializeWithDummyUsers() {
        // Ensure all indices are created first
        ...
        DummyUser dummyData[20] = {
            {1, "Mohammed", "Khan", "Pakistan", PLATINUM},
            {2, "Ahmed", "Ahmed", "USA", GOLD},
            {3, "Ali", "Malik", "Saudi Arabia", SILVER},
            {4, "Omar", "Hussain", "Turkey", REGULAR},
            {5, "Yusuf", "Abdul", "Pakistan", NEW},
